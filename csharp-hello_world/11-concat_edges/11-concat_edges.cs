...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Wir suchen die Wörter direkt im String, statt Indizes zu raten
        Console.WriteLine(str.Substring(str.IndexOf("object-oriented"), 15) + " " + str.Substring(str.IndexOf("programming"), 11) + " in " + str.Substring(0, 2));
    }
}